  ...
  return (
    <main className="min-h-screen text-retro-dark flex flex-col md:flex-row justify-center p-4 pb-32 md:p-6 select-none relative gap-6">
      ...
      <div className="w-0 h-0 overflow-hidden opacity-0 pointer-events-none absolute">
        <div ref={pitchRef} id={`bloque1`} className="w-[400px] bg-white border-3 border-retro-dark p-4 aspect-[3/4] flex flex-col justify-between gap-2 relative">
        ...
        <div ref={statsCardRef} id="bloque2" className="w-[380px] border-3 border-retro-dark bg-white">
        ...
        {/* SETUP */}
        {setupMode === 'SETUP' && ( 
          <div className="h-full w-full max-w-md bg-white border-4 border-retro-dark p-6 shadow-[6px_6px_0px_0px_rgba(17,24,39,1)] mt-4">
                ...
                <header className="w-full flex justify-between items-center mb-6">
                  <div>
                    <h1 className="retro-heading text-5xl text-retro-green">
                      FOOT<span className="text-retro-red">GAMES</span>
                    </h1>
