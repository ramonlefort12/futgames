...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen text-retro-dark flex flex-col items-center p-4 pb-32 md:p-6 select-none relative">
      ...
      {/* MENUS COMPARTIDOS */}
      <nav className="w-full max-w-md grid grid-cols-3 gap-2 mb-6 font-mono text-[10px] uppercase tracking-wider text-center">
        <Link href="/grid" className="bg-white border-2 border-retro-dark p-2 font-bold shadow-[2px_2px_0px_0px_rgba(17,21,39,1)] hover:bg-retro-green hover:text-retro-cream active:translate-y-0.5">🧩 grid</Link>
        <Link href="/higher-lower" className="bg-white border-2 border-retro-dark p-2 font-bold shadow-[2px_2px_0px_0px_rgba(17,21,39,1)] hover:bg-retro-red hover:text-retro-cream active:translate-y-0.5">▲ más/menos</Link>
        <Link href="/trivia" className="bg-white border-2 border-retro-dark p-2 font-bold shadow-[2px_2px_0px_0px_rgba(17,21,39,1)] hover:bg-retro-yellow hover:text-retro-dark active:translate-y-0.5">🧠 trivia</Link>
      </nav>
        ...
        <>
          ...
          {game.view === 'TOURNAMENT_BRACKET' && (
            <div className="w-full max-w-6xl flex flex-col items-center px-2">
              ...
              {/* ÁRBOL DE BRACKETS EN ESPEJO - Contenedor responsivo optimizado */}
              {game.bracket && (
